...
DEST_EXCITATION_MAPS=excitation_maps/non-contrastive
DEST_EXCITATION_VIDEOS=excitation_videos/non-contrastive

NET_CONFIG=ucf101_spatial_config

GEN_OPTIONS="--colormap hot --desaturate --no-contrastive"

# Config for scripts
export PYTHONPATH="$HOME/thesis/lib:$HOME/thesis/net_configs"
GEN_TEMPORAL_EXCITATION_MAPS_SCRIPT="$HOME/thesis/scripts/generate_spatial_excitation_maps.py"
